...
* DESCRIPTION   : This file contains all of the function definitions for any and
*                 all functions related to delimited file access. All of the code
*                 in this file was written by Morgan Tabor.
*/
